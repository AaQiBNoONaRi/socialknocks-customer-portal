  ...
  const renderSidebarItem = (id: AITool, label: string, icon: any, desc: string) => {
      ...
      return (
        <button 
            ...
            className={`w-full text-left p-4 rounded-xl border transition-all mb-3 flex items-start gap-3 group ${
                activeTool === id 
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                      ...
                      {activeTool === 'knockout' && (
                          <div className="flex-1 flex items-center justify-center flex-col text-slate-400">
                              <div className="w-24 h-24 bg-gradient-to-tr from-amber-400 to-orange-500 rounded-full flex items-center justify-center mb-6 text-white shadow-xl shadow-orange-200 animate-pulse">
                                  <Zap size={40} fill="currentColor" />
                              </div>
                              <h3 className="text-2xl font-bold text-slate-900 mb-2">KnockOUT AI</h3>
                              <p className="max-w-md text-center">Our flagship autonomous agent that analyzes trends and auto-creates high-performing posts is currently in closed beta.</p>
                              <button className="mt-8 px-6 py-3 border border-slate-300 rounded-xl font-bold text-slate-700 hover:bg-slate-50">Request Access</button>
                          </div>
                      )}
                  </div>
              </div>
