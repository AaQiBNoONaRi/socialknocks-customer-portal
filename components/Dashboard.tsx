            ...
            <div className="flex justify-between items-end">
                <div>
                    ...
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight">
                        {user?.name ? `Welcome, ${user.name}` : user?.email ? `Welcome, ${user.email.split('@')[0]}` : 'Dashboard Overview'}
                    </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <button className="p-2 hover:bg-slate-50 rounded-lg text-slate-400 hover:text-indigo-600 transition-colors" aria-label="Open Trends Detail" title="Open Trends Detail">
